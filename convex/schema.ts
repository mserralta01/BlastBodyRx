...
export default defineSchema({
  ...
  }).index("by_email", ["email"]).index("by_email_and_status", ["email", "status"]).index("by_status", ["status"]),
  ...
  customers: defineTable({
    ...
    tags: v.optional(v.array(v.string())),
    demoSeedKey: v.optional(v.string()),
    createdAt: v.number(),
    updatedAt: v.number(),
  }).index("by_email", ["email"]).index("by_demo_seed_key", ["demoSeedKey"]),
  orders: defineTable({
    ...
    createdAt: v.number(),
    updatedAt: v.number(),
  }).index("by_order_number", ["orderNumber"]).index("by_created_at", ["createdAt"]).index("by_demo_seed_key", ["demoSeedKey"]),
  discounts: defineTable({
    ...
    demoSeedKey: v.optional(v.string()),
  }).index("by_code", ["code"]).index("by_demo_seed_key", ["demoSeedKey"]),
  batches: defineTable({
    ...
    published: v.boolean(),
    demoSeedKey: v.optional(v.string()),
  }).index("by_product", ["productSlug"]).index("by_lot", ["lotNumber"]).index("by_demo_seed_key", ["demoSeedKey"]),
  storeSettings: defineTable({
    ...
    demoModeEnabled: v.optional(v.boolean()),
    demoDataSeededAt: v.optional(v.number()),
    updatedAt: v.number(),

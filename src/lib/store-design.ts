export const peptideThemes = [
  ...
  { id: "biofuture", name: "BioFuture", description: "BlastBodyRx amber glass, electric lime, and clean cyan details for a bold next-generation peptide brand.", colors: ["#078C9A", "#87D92F", "#F7F3E8", "#111712"] },
] as const;
